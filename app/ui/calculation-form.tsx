...
import ImageUploadUI from './file-upload';
...
export default function CalculationForm({ state, formAction }: { state: State, formAction: any }) {
    ...
    return (
        <div className="flex-1 flex gap-4 shadow-md max-w-3xl flex-col rounded-lg px-5 py-10 bg-white dark:bg-black">
            {/* Title */}
